  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "hover:bg-accent hover:text-foreground data-[state=active]:text-secondary data-[state=active]:after:bg-secondary data-[state=active]:hover:bg-accent relative after:absolute after:inset-x-0 after:bottom-0 after:-mb-1 after:h-0.5 data-[state=active]:bg-transparent data-[state=active]:shadow-none",
        className
      )}
      {...props}
    />
